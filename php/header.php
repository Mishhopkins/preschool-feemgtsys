        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="<?php if($page=='grade'){ echo 'active-menu';}?>" href="grade.php"><i class="fa fa-th-large"></i>Classes </a>
                    </li>

                    <li>
                        <a class="<?php if($page=='sessions'){ echo 'active-menu';}?>" href="addSessions.php"><i class="fa fa-clock-o "></i>Sessions </a>
                    </li>
                    
					<li>
                        <a class="<?php if($page=='fees'){ echo 'active-menu';}?>" href="fees.php">
                            <i class="fa fa-money"></i>Fees Section
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="<?php if($page=='setfees'){ echo 'active-menu';}?>" href="setfees.php"> 
                                <i class="fa fa-money"></i>Set Fees</a>
                            </li>
                            <li>
                                <a class="<?php if($page=='managefees'){ echo 'active-menu';}?>" href="managefees.php">
                                <i class="fa fa-user"></i>Manage Fees</a>
                            </li>
                        </ul>
                    </li>
